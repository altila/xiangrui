...
//定义回调URL通用的URL
define('URL_CALLBACK', "{$_SERVER['HTTP_HOST']}/User/JointLogin/callback?type=");

return array(

	//腾讯QQ登录配置
	'THINK_SDK_QQ' => array(
		'APP_KEY'    => '100575589', //应用注册成功后分配的 APP ID
		'APP_SECRET' => 'e1aa25dab4fc117beec5382aec3cb3be', //应用注册成功后分配的KEY
